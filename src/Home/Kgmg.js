    ...
    <div>
        ...
        <div className="mt-[88px] font-dmsans">
                ...
                <div className="mt-10 px-20 text-justify" id="content">
                           <div>The K. Ganesh and Meena Ganesh Scholarship for Entrepreneurship Development (famously known as KGMG) aims to inspire postgraduate students to think entrepreneurially. At IIT Madras, there are thousands of postgraduate students with research that could make a real difference if turned into a business. This scholarship helps students turn their thesis or project work into viable start-up ideas, providing support to bridge the gap from research to a successful business.</div>
                           <div className="mt-14">    
